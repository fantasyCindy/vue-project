var showStockList = require('./stockList-1.2.js');
...
var header = function() {
    ...
    var container = $('#yn-header'),
        ...
        // unRead = container.find('.envelope'),
        login = $("#ynLogin"),
        logout = $("#ynLogout"),
        register = $('#register')
    ...
    var event = function() {
        ...
        register.on('click',function(){
            var href = window.location.href
            // window.location.href=`http://101.201.41.116/account/register.htm?systemCode=yuetougu&clientUrl=${href}`
